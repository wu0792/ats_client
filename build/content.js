...
const //COMMON_THRESHOLD = 500,
    connContentAndBackground = chrome.runtime.connect({ name: consts["b" /* CONNECT_ID_INIT_CONTENT */] })
...
function listen() {
    userActivityListener = new UserActivityListener(
        ...
        consts["a" /* ACTION_TYPES */].USER_ACTIVITY_KEYDOWN,
        consts["a" /* ACTION_TYPES */].USER_ACTIVITY_CLICK,
        consts["a" /* ACTION_TYPES */].USER_ACTIVITY_SCROLL,
        consts["a" /* ACTION_TYPES */].USER_ACTIVITY_RESIZE])
